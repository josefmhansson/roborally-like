...
export const CARD_DEFS: Record<CardDefId, CardDef> = {
  ...
  reinforce_shrug_off: {
    id: 'reinforce_shrug_off',
    name: 'Shrug Off',
    description: 'Remove all debuffs from a unit and give it Undying this turn.',
    type: 'reinforcement',
    classId: 'warleader',
    actionCost: 1,
    requires: { unit: 'friendly' },
  ...
  reinforce_spikes: {
    id: 'reinforce_spikes',
    name: 'Spikes',
    description: 'A unit reflects 1 damage back to its attacker for 2 turns.',
    type: 'reinforcement',
    classId: 'warleader',
    actionCost: 1,
    requires: { unit: 'friendly' },
  ...
  reinforce_lightning_barrier: {
    id: 'reinforce_lightning_barrier',
    name: 'Lightning Barrier',
    description: 'Give a unit a lightning barrier that deals 1 damage to adjacent enemies at the end of each turn.',
    type: 'reinforcement',
    classId: 'archmage',
    actionCost: 1,
    requires: { unit: 'friendly' },
  ...
  move_double_steps: {
    id: 'move_double_steps',
    name: 'Double Steps',
    description: 'Move 2 different friendly units 1 tile each.',
    type: 'movement',
    classId: 'commander',
    requires: { unit: 'friendly', unit2: 'friendly', tile: 'any', tile2: 'any' },
    effects: [
      {
        type: 'moveToTile',
        unitParam: 'unitId',
  ...
  move_converge: {
    id: 'move_converge',
    name: 'Converge',
    description: 'Every friendly unit moves 1 tile toward a chosen tile and faces the moved direction.',
    type: 'movement',
    classId: 'commander',
    requires: { tile: 'any' },
    effects: [
  ...
  move_dash: {
    id: 'move_dash',
    name: 'Dash',
    description: 'Move 1 or 2 steps forward.',
    type: 'movement',
    classId: 'warleader',
    actionCost: 0,
    requires: { unit: 'friendly', distanceOptions: [1, 2] },
    effects: [
      {
        type: 'move',
        unitParam: 'unitId',
  ...
  attack_line: {
    id: 'attack_line',
    name: 'Flame Thrower',
    description: 'Spew flames forward up to 3 tiles, dealing 2 damage to every unit in line.',
    type: 'attack',
    classId: 'archmage',
    requires: { unit: 'friendly' },
    effects: [
  ...
  attack_ice_bolt: {
    id: 'attack_ice_bolt',
    name: 'Ice Bolt',
    description: 'Face a direction, then deal 2 damage to the first unit in line and Slow it for 2 turns.',
    type: 'attack',
    classId: 'archmage',
    actionCost: 1,
  ...
  attack_bash: {
    id: 'attack_bash',
    name: 'Bash',
    description: 'Face a direction, then deal 2 damage and Stun an adjacent unit this turn.',
    type: 'attack',
    classId: 'warleader',
    actionCost: 2,
    keywords: ['Priority'],
  ...
  attack_fireball: {
    id: 'attack_fireball',
    name: 'Fireball',
    description: 'Face a direction, then deal 2 damage to the first unit in line and all adjacent tiles around it.',
    type: 'attack',
    classId: 'archmage',
    actionCost: 2,
    requires: { unit: 'friendly', direction: true },
  ...
  spell_pitfall_trap: {
    ...
    name: 'Bear Trap',
    description:
      'Place a hidden bear trap adjacent to a friendly unit. Trigger: 2 damage and Snare for 2 turns; movement stops.',
    type: 'spell',
    classId: 'commander',
  ...
  spell_petrify: {
    id: 'spell_petrify',
    name: 'Petrify',
    description: 'Target unit is Stunned for 2 turns.',
    type: 'spell',
    classId: 'archmage',
    actionCost: 1,
    requires: { unit: 'any' },
  ...
  spell_brain_freeze: {
    id: 'spell_brain_freeze',
    name: 'Brain Freeze',
    description: "All opponent cards become Slow next turn. If a card would be both Priority and Slow, both cancel out.",
    type: 'spell',
    classId: 'archmage',
    actionCost: 2,
    requires: {},
